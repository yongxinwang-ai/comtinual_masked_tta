...
def main():
    ...
    elif conf.args.model == "resnet101":
        from models import ResNet
...
def parse_arguments(argv):
    ...
    #CMT
    #Todo:
    parser.add_argument('--alpha', type=float, default=0.999, help='alpha')
    parser.add_argument('--restoration_factor_cmt', type=float, default=0.01, help='restoration factor')
    parser.add_argument('--aug_threshold_cmt', type=float, default=0.92, help='augmentation threshold')
    parser.add_argument('--pseudo_label_weight', default=None,help='The quality weight of pesudo label')
    parser.add_argument('--mask_block_size', type=int, default=32,help='mask block size')
    parser.add_argument('--mask_ratio', default=0.5, type=float, help='Masked image ratio')
    parser.add_argument('--mask_color_jitter_s', type=float, default=0, help='augmentaation parameters s')
    parser.add_argument('--mask_color_jitter_p', type=float, default=0, help='augmentaation parameters j')
    parser.add_argument('--mask_blur', default=False, type=bool, help='augmentaation parameters blur')
